                ...
                <div className=" gap-20  lg:flex p-5">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="lg:flex gap-10">
                            <p className="lg:flex gap-4">Tags: {tags.map(tag => <div className="text-green-500">#{tag}</div>)}</p>
                            <p className="flex items-center lg:justify-center gap-2"><IoLocationOutline></IoLocationOutline> Year of Publishing: {yearOfPublishing}</p>
                        </div>
                        <div className="flex gap-20">
                            <p className="flex"><AiOutlineUsergroupDelete size={20}></AiOutlineUsergroupDelete> Publisher: {publisher}</p>
                            <p className="flex lg:items-center"><MdOutlineContactPage size={20}></MdOutlineContactPage> Page: {totalPages}</p>
                        </div>
                        <hr />
